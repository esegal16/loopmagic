...
- **Styling:** Light formatting only (bold headers, basic borders)
- **Images:** Embed up to 5 photos, resize to 400px width (verify ExcelJS supports image embedding before building)
...
3. **Excel generation** (`src/lib/excel/generator.ts`)
   - Should be straightforward
   - 3 tabs: Property Details, Analysis, Photos
   - Clean formatting, embedded images
